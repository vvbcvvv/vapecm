...
local shalib = debugLoad(GetURL("Libraries/sha.lua"), 'sha.lua', EXECUTION_INFO)
local entity = debugLoad(GetURL("Libraries/entityHandler.lua"), 'entityHandler.lua', EXECUTION_INFO)
local whitelisted = {
	players = {
			...
			if callback then
				...
				if not suc then
					...
					framebutton1.MouseButton1Click:connect(function()
						spawn(function()
							setclipboard("https://github.com/skiddinglua/NewVapeUnpatched4Roblox/wiki/Turning-on-Highlights")
