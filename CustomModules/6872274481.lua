...
runFunction(function()
	local Nightmare = {Enabled = false}
  Nightmare = GuiLibrary["ObjectsThatCanBeSaved"]["NewVapeWindow"]["Api"].CreateOptionsButton({
	  ["Name"] = "Nightmare",
	  ["Function"] = function(callback)
		  if callback then	
...
game:GetService("ReplicatedStorage").rbxts_include.node_modules:FindFirstChild("@rbxts").net.out._NetManaged.Emote:InvokeServer(unpack(args))
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																
	  end
		  end,
		  ["HoverText"] = "Nightmare Emote v2"
	  })
  end)																																																																																																																																																																																																																																																																																												
